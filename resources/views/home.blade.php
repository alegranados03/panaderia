		...
		<div class="col-lg-10 col-12">
			<div class="row justify-content-between text-center">
				...
				<div class="col-12 col-md-4 col-xl-3" name="procedimientos">
					<div class="row">
						<div class="col-12">
							<a href="{{route('recetas.index')}}" class="btn btn-block btn-light">
								<i class="fa fa-file" style="font-size: 150px;color: black;"></i>
							</a>
						</div>
					</div>
					<div class="row">
						<div class="col-12">
							<a href="{{route('recetas.index')}}" class="btn btn-block btn-light" style="color: black;"><h3>Receta</h3>
							</a>
						</div>
					</div>
				</div>
				...
				<div class="col-12 col-md-4 col-xl-3" name="procedimientos">
					<div class="row">
						<div class="col-12">
								<a href="{{route('materiaPrima.index')}}" class="btn btn-block btn-light">
									<i class="fa fa-list-alt" style="font-size: 150px;color: black;"></i>
								</a>
						</div>
					</div>
					<div class="row">
						<div class="col-12">
							<a href="{{route('materiaPrima.index')}}" class="btn btn-block btn-light" style="color: black;"><h3>Materia prima</h3>
							</a>
						</div>
					</div>
				</div>
